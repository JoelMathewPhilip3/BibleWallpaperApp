...
data class GeneratedWallpaper(val bitmap: Bitmap, val verse: Verse)

object WallpaperImageCreator {
    fun create(width: Int, height: Int, verse: Verse, seed: Long = System.nanoTime()): GeneratedWallpaper {
        val bitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888)
        val canvas = Canvas(bitmap)
        val random = Random(seed)
        val scene = random.nextInt(7)
        ...
        return GeneratedWallpaper(bitmap, verse)
    }
