...
Android app that automatically creates a scenic nature wallpaper with a Bible verse overlay and sets it as the phone wallpaper every 12 hours.

## What it does

- Automatically schedules wallpaper generation every 12 hours using Android WorkManager.
...
- `WallpaperScheduler.kt` - schedules the 12-hour background worker
